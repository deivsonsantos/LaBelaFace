...
<head> 
	...
	<title>Salão La Bela Face - Cabelo & Estética</title> 
			...
			<div class="container"> 
				...
				<div class="collapse navbar-collapse"> 
					<ul class="nav navbar-nav navbar-right"> 
						...
						<li class="scroll"><a href="#our-team">Nossa Equipe</a></li> 
	...
	<div class="container">
		<div class="text-center">
			<div class="col-sm-8 col-sm-offset-2">
				<h2 class="title-one">Por que nós?</h2>
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#missao" data-toggle="tab"><i class="fa fa-chain-broken"></i> Missão</a></li>
						<li><a href="#visao" data-toggle="tab"><i class="fa fa-th-large"></i> Visão</a></li>
						<li><a href="#valores" data-toggle="tab"><i class="fa fa-users"></i> Valores</a></li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane fade in active" id="missao">
							<div class="media">
								<img class="pull-left img-rounded col-xs-5" src="images/about-us/missao.png" alt="imagem da missão"> 
								<div class="media-body">
									<p>O Salão La Bela Face tem como missão, contribuir para a melhoria da qualidade de vida e da saúde, principalmente das mulheres, por meio da criação e comercialização de soluções de beleza a partir de uma postura empresarial ética e socialmente responsável.</p>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="visao">
							<div class="media">
								<img class="pull-left img-rounded col-xs-5" src="images/about-us/visao.png" alt="Imagem da Visão"> 
								<div class="media-body">
						...
						<div class="tab-pane fade" id="valores">
							<div class="media">
								<img class="pull-left img-rounded col-xs-5" src="images/about-us/valores.png" alt="Imagem de Valores"> 
								<div class="media-body">
						...
						<div class="row item active">
							<div class="col-sm-6 col-md-3">
								<div class="single-member">
									<img src="images/our-team/vanusia.jpg" alt="team member" />
									<h4>Vanúsia Santos</h4>
									<h5>Sr. Web Developer</h5>
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod</p>
									<div class="socials">
										<a href="https://www.facebook.com/vanusiabf"><i class="fa fa-facebook"></i></a>
...
=======
											<p>Oferecemos o melhor suporte para tirar suas dúvidas</p>
>>>>>>> 04198cef4461bbd77191b6da1d16278a2782b528
										</div>
									</div>
								</div>
							</div>
							<div class="container">
								<div class="contact-details">
									...
									<div class="row text-center clearfix">
										<div class="col-sm-6">
<<<<<<< HEAD
											<div class="contact-address"><address><p><span>Salão</span>LaBelaFace</p><strong>Av. Vereador Dário Marsíglia<br> Nº 16-A, Tabuleiro do Martins</strong><br><small>( Lorem ipsum dolor sit amet, consectetuer adipiscing elit )</small></address>
=======
